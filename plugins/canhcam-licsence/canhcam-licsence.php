...
if (!class_exists('CanhCam_Licsence_Class')) {
	...
	class CanhCam_Licsence_Class
	{
		...
		function getDateExpiration()
		{
			...
			return ['expiration_time' => $expiration_time, 'expiration_time_format' => $expiration_time_format, 'overdue_time_format' => $overdue_time_format];
		}
		...
		function admin_notices_career()
		{
			...
			['expiration_time_format' => $expiration_time_format, 'overdue_time_format' => $overdue_time_format] = $this->getDateExpiration();
			$isDateExpiration = $this->isDateExpiration();
