...
function wp_bootstrap_pagination($args = array())
{
	...
	if ($firstpage && (1 != $page)) $echo .= '<li class="previous"><a href="' . $firstpage . '">' . __('Đầu tiên', 'text-domain') . '</a></li>';
	...
	if ($lastpage) {
		$echo .= '<li class="next"><a href="' . $lastpage . '">' . __('Cuối cùng', 'text-domain') . '</a></li>';
	}
